...
bash -n v2/install.sh v2/install-release.sh v2/devbox/entrypoint.sh v2/devbox/configure-pi.sh v2/devbox/pi-wrapper.sh v2/examples/herdr-span/install.sh
