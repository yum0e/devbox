...
uv run --no-project python -m py_compile v2/launcher/dispatcher.py v2/launcher/span_runtime.py v2/launcher/span_supervisor.py v2/credential_proxy/span_bridge.py v2/examples/probe-span/probe-span v2/examples/probe-span/probe-span-client v2/examples/probe-span/register.py v2/examples/herdr-span/herdr-span v2/examples/herdr-span/herdr v2/examples/herdr-span/register.py v2/package-release.py
