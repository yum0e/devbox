...
uv run --no-project python -m py_compile v2/launcher/dispatcher.py v2/launcher/span_runtime.py v2/launcher/span_supervisor.py v2/credential_proxy/span_bridge.py v2/package-release.py
