...
def copy_release_assets(source,destination):
    ...
    for relative in ("launcher/devc2.py","launcher/dispatcher.py","launcher/command_projection.py","launcher/scoped_exec_projection.py","devbox/entrypoint.sh","devbox/tact-wrapper.sh","devbox/herdr-wrapper.py","spans/openai/world","spans/github/world","spans/ssh-agent/world"):
