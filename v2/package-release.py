...
EXECUTABLE={"install.sh","devbox/entrypoint.sh","devbox/configure-pi.sh","launcher/devc2.py","launcher/dispatcher.py","launcher/command_projection.py","spans/openai/world","spans/github/world","spans/ssh-agent/world","spans/diagnostics/world"}
