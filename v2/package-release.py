...
EXECUTABLE={"install.sh","devbox/entrypoint.sh","devbox/tact-wrapper.sh","launcher/devc2.py","launcher/dispatcher.py","launcher/command_projection.py","launcher/scoped_exec_projection.py","spans/openai/world","spans/github/world","spans/ssh-agent/world","spans/diagnostics/world"}
